...
def takecolumns(input_file):
    ...
    while selected_column!= '-1':
        ...
        selected_column=input("Enter the single column number you need and enter -1 to end:  ")
...
def build_kg_list(columns_list):
    ...
    while triger!='-1':
        try:
            ...
            i=i+1
            triger=input("Press Enter to continue input -1 to end")
        except:
            print("Error, please re-enter")
            continue
    for i in kg_list:
...
def assig_index(df,itemdict_file,relationdict_file):
    ...
    relationtxt=open(relationdict_file,'a',encoding='utf-8')
    itemdict=dict()
    relationdict=dict()
    ii=0
    ri=0
...
def assig_business_index(df,itemdict,ii,itemdict_file):
    ...
    usertxt=open(userdict_file,'a',encoding='utf-8')
